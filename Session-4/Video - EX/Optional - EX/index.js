...
console.log(movie.results[0].vote_average);
console.log(movie.results[0].genres);
for(let i = 0; i < movie.length; i++){
    console.log(movie[i].title);
    console.log(movie[i].vote_average);
    console.log(movie[i].genres);
}
console.log("--------------------");
...
for (let index = 0; index < movie.results.length; index++) {
    for (let i = 0; i < movie.results[index].genres.length; i++) {
        if (genre == movie.results[index].genres[i]) {
            console.log(movie.results[index]);
            break;
        }
    }
...
let rate1 = Number(prompt("what minimum rate you want"));
for (let index = 0; index < movie.results.length; index++) {
    if (rate1 > movie.results[index].vote_average) {
        console.log(movie.results[index]);
        break;
    }
}
